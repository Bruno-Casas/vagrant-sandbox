...
while ! echo $(journalctl --no-pager -n 10 -u minio) | grep 'Documentation:' > /dev/null; do
    echo 'Aguardando o servidor de arquivos' && sleep 1;
done;

echo 'Configurando o bucket de armazenamento' 
